...
const Curtain_hagl04  = require('./Sensors/Curtain_hagl04');
...
const states = {
    ...
    power_consumed:   {name: 'Power consumed',        role: 'value.consumption', write: false, read: true, type: 'number', unit: 'kWh'},
...
const devices = {
    ...
    acpartner3:           {type: 'acpartner.v3',    fullName: 'Xiaomi Aqara AC partner Gateway', ClassName: Gateway, states: {
            illumination: {name: 'Illumination',    role: 'value.lux',         write: false, read: true,  type: 'number', unit: 'lux'},
            mid:          {name: 'Music ID',        role: 'state',             write: true,  read: false, type: 'number', desc: '10000 - stop, 10005 - custom ringtone'},
            ac_state:     {name: 'AC state',        role: 'state',             write: false, read: true,  type: 'number'},
    ...
    curtain_hagl04:    {type: 'curtain.hagl04',    fullName: 'Xiaomi Aqara Smart Curtain B1', ClassName: Curtain_hagl04, states: {
            voltage:      states.voltage,
            percent:      states.percent,
